                ...
                <table class="table">
                 <tr>
				   ...
				   <td> 
						...
						<div class="portlet-body">
				      <div class="table-responsive">	<!-- portlet-body flip-scroll-->
						 ...
						 ?>
							<tr bgcolor="<?=$row?>" onmouseover=" this.style.background='#ECF5B6'; " onmouseout=" this.style.background='<?=$row?>'; ">
							  ...
							  <td nowrap >
                                  ...
                                  <a href="index.php?cmd=print&id=<?=$arr[$i]['id']?>" target="_blank" class="btn default btn-xs purple"><i class="fa fa-edit"></i>Print</a> 
                                  <a href="index.php?cmd=send_email&id=<?=$arr[$i]['id']?>&customers_id=<?=$arr[$i]['customers_id']?>"  class="btn default btn-xs purple"><i class="btn default btn-xs purple"></i>Send Email</a>
