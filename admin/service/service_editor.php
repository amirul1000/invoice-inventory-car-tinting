	                ...
	                <table class="table">
							 <tr>
							  <td>  
								 ...
								 <form name="frm_service" method="post"  enctype="multipart/form-data" onSubmit="return checkRequired();">			
								  <div class="portlet-body">
						         <div class="table-responsive">	
					                <table class="table">
										 <tr>
						 <td>Service Name</td>
						 <td>
						    <input type="text" name="service_name" id="service_name"  value="<?=$service_name?>" class="form-control-static">
						 </td>
				     </tr><tr>
						 <td>Cost</td>
						 <td>
